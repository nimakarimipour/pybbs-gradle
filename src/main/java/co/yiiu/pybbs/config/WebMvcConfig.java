...
public class WebMvcConfig extends WebMvcConfigurationSupport {
  ...
  @Resource private CommonInterceptor commonInterceptor;
  @Resource private UserInterceptor userInterceptor;
  ...
  protected void addInterceptors(InterceptorRegistry registry) {
    ...
    registry
        ...
        .addPathPatterns("/settings", "/settings/*", "/topic/create", "/topic/edit/*");
  }
