...
public class ShiroConfig {
  ...
  @Resource private MyShiroRealm myShiroRealm;
  ...
  public ShiroFilterFactoryBean shiroFilterFactoryBean(
    ...
    // <!-- authc:所有url都必须认证通过才可以访问; user: 表示rememberMe后就可以访问 anon:所有url都都可以匿名访问 {@link
  ...
  public SimpleCookie rememberMeCookie() {
    ...
    // 记住我cookie生效时间 单位秒
    int adminRememberMeMaxAge =
        Integer.parseInt(
            systemConfigService.selectAllConfig().get("admin_remember_me_max_age").toString());
