package co.yiiu.pybbs.config.realm; // package co.yiiu.pybbs.config.realm;
//
...
/** 不使用自定义的filter处理登录逻辑了 换回Controller处理 好处：shiro的错误信息可以捕获到，然后进行一些处理再返回给用户，避免出现一些莫名其妙的问题 */
