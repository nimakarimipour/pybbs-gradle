...
public class TopicService implements ITopicService {
  ...
  @Resource private ITopicTagService topicTagService;
  ...
  @Resource private IndexedService indexedService;
  ...
  public Topic insert(String title, String content, String tags, @RUntainted User user) {
    ...
    user.setScore(
        user.getScore()
            + Integer.parseInt(
                systemConfigService.selectAllConfig().get("create_topic_score").toString()));
  ...
  public void delete(Topic topic) {
    ...
    user.setScore(
        user.getScore()
            - Integer.parseInt(
                systemConfigService.selectAllConfig().get("delete_topic_score").toString()));
    userService.update(user);
    // 删除索引
  ...
  public int vote(Topic topic, @RUntainted User user) {
    ...
    if (strings.contains(String.valueOf(user.getId()))) { // 取消点赞行为
      ...
      userScore -=
          Integer.parseInt(systemConfigService.selectAllConfig().get("up_topic_score").toString());
    } else { // 点赞行为
