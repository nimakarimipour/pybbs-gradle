...
public class FileUploadPlugin {
  ...
  public Object upload(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
    String cloudStoragePlatform =
        systemConfigService.selectAllConfig().get("cloud_storage_platform");
    log.info("fileUtilHook.upload: {}", cloudStoragePlatform);
    Object[] args = proceedingJoinPoint.getArgs();
    if (StringUtils.isEmpty(cloudStoragePlatform)
        || UploadPlatForm.LOCAL.name().equals(cloudStoragePlatform)) {
