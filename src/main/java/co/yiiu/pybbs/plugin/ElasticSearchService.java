...
public class ElasticSearchService implements BaseService<RestHighLevelClient> {
  ...
  public boolean createIndex(String type, XContentBuilder mappingBuilder) {
    try {
      ...
      request.settings(
          Settings.builder().put("index.number_of_shards", 1).put("index.number_of_shards", 5));
   ...
   */
  public MyPage<Map<String, Object>> searchDocument(
      Integer pageNo, Integer pageSize, String keyword, String... fields) {
    try {
