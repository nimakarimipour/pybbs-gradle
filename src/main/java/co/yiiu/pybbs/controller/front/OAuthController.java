...
public class OAuthController extends BaseController {
  ...
  @Resource private IOAuthUserService oAuthUserService;
  @Resource private CookieUtil cookieUtil;
  @Resource private SocialPlugin socialPlugin;
  ...
  public String callback(
      @PathVariable("type") String type, AuthCallback callback, HttpSession session) {
    ...
    if (oAuthUser == null) {
      ...
      user =
          userService.addUser(
              username, null, avatarUrl, email, bio, blog, StringUtils.isEmpty(email));
      oAuthUserService.addOAuthUser(
          Integer.parseInt(githubId),
          type.toUpperCase(),
